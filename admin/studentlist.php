                            ...
                            <?php while($row = mysql_fetch_array($student)): ?>                            
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="data/settings_model.php?q=addaccount&level=student&id=<?php echo $row['id']?>" title="Generate Account" class="confirmacc"><i class="fa fa-key fa-2x text-warning"></i></a>
                                        <a href="studentsubject.php?id=<?php echo $row['id'];?>" title="View Subjects"><i class="fa fa-bar-chart-o fa-2x text-success"></i></a> &nbsp;
