    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <a href="reportcard.php?id=<?php echo $id; ?>" target="_blank"><button type="button" name="submit" class="btn btn-success"><i class="fa fa-print"></i> Print Grade Sheet</button></a>
                <?php endwhile; ?>
                <hr />
